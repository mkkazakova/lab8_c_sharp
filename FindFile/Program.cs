    ...
    static void Main(string[] args)
    {
        ...
        else
        {
            foreach (string filePath in files)
            {
                ...
                //string compressedFilePath = Path.ChangeExtension(filePath, ".gz"); // там же где и был
                string fileName = Path.GetFileNameWithoutExtension(filePath) + ".gz";
                string compressedFilePath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..\\..\\..\\..\\" + fileName);
